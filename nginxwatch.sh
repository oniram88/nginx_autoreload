...
# version     1.0.0                                           #
###############################################################
## Modifiche apportate da marino per utilizzare le variabilia di environment
# Possibile utilizzare una variabile DI ENV per definire dove leggere le configurazioni
